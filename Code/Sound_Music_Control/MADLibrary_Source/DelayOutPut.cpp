/********************						***********************/
//
//	Player PRO 5.8 - DRIVER SOURCE CODE - THE CORE SOUNND ENGINE
//
//	Library Version 5.8
//
...
//	SWITZERLAND
//
//	COPYRIGHT ANTOINE ROSSET 1996, 1997, 1998, 1999, 2000, 2001
//
...
void Sampler16AddDelay( Channel *curVoice, long	*ASCBuffer, MADDriverRec *intDriver)
{
	...
	
	{
		...
		while( i-- > 0)
		{
			chnVol2	= InterpolateInline( i, intDriver->ASCBUFFER, chnVol2S, chnVol2D);
			chnVol	= InterpolateInline( i, intDriver->ASCBUFFER, chnVolS, chnVolD);
