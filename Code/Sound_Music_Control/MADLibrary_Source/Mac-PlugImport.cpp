...
void MInitImportPlug( MADLibrary *inMADDriver, Ptr PlugsFolderName)
{
	...
	{
		MYC2PStr2( PlugsFolderName,(char *)pascalPlugsFolderName);
		PlugsFolderOK = 0;
		NScanDirImportPlug( inMADDriver, dirID, vRefNum, (unsigned char*) pascalPlugsFolderName);
	}
